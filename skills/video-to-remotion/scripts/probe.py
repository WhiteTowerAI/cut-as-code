...
Replaces the hand-edited SRC_W / SRC_H / DURATION_S placeholders in Root.tsx —
forget to edit those and you get an upscaled/letterboxed render.

Usage:
  python probe.py [source_video] [out_json]
Defaults:
  source_video = work/source.mp4     (remotion skill stages the cut in work/)
...
def main():
    src = sys.argv[1] if len(sys.argv) > 1 else "work/source.mp4"
