/* Original Codrops project: TextBlockTransitions. */
/* Generated deterministic HyperFrames adapter for codrops-textblocktransitions-index2. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const INTERACTION = {"mode":"transition","duration":6,"actions":[{"at":0.8,"type":"click","selector":".trigger"}]};
  ...
  const SOURCE_BODY = "\n\t\t<main>\n\t\t\t<div class=\"frame\">\n\t\t\t\t<h1 class=\"frame__title\">Inspiration for Text Block Transitions</h1> \n\t\t\t\t<a class=\"frame__back\" href=\"https://tympanus.net/codrops/?p=72862\">Back to the article</a>\n\t\t\t\t<a class=\"frame__prev\" href=\"https://tympanus.net/Development/OnScrollFilter/\">Previous demo</a>\n\t\t\t\t<button class=\"trigger unbutton\">Click to transition</button>\n\t\t\t\t<nav class=\"demos\">\n\t\t\t\t\t<span class=\"demos__title\">Variations:</span>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index.html\">1</a>\n\t\t\t\t\t<span class=\"demos__item\">2</span>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index3.html\">3</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index4.html\">4</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index5.html\">5</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index6.html\">6</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index7.html\">7</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index8.html\">8</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index9.html\">9</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index10.html\">10</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index11.html\">11</a>\n\t\t\t\t\t<a class=\"demos__item\" href=\"index12.html\">12</a>\n\t\t\t\t</nav>\n\t\t\t</div>\n\t\t\t<div class=\"content\">\n\t\t\t\t<div class=\"content__text\" data-splitting>\n\t\t\t\tAs the sun dipped below the horizon, casting its final golden hues upon the landscape, our hearts brimmed with anticipation. The open road stretched before us like an invitation to explore the depths of the unknown, beckoning us with endless possibilities and promising transformative experiences yet to be discovered. \n\t\t\t\t</div>\n\t\t\t\t<div class=\"content__text\" data-splitting>\n\t\t\t\tWith weathered maps in hand and a shared sense of adventure, we eagerly embarked on this exhilarating journey of self-discovery, fully embracing the enigmatic path that lay ahead. Each passing mile brought forth breathtaking wonders, as if the very fabric of nature tenderly whispered its well-guarded secrets to us.\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</main>\n\t\t\n\t\t\n\t\t\n\t\t\n\t";
