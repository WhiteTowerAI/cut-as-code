...
function (__hf) {
delete globalThis.parcelRequireName;
delete globalThis.parcelRequire0103;
...
function updateLink(link) {
    ...
    newLink.setAttribute('href', link.getAttribute('href').split('?')[0] + '?' + __hf.dateNow()); // $FlowFixMe
    link.parentNode.insertBefore(newLink, link.nextSibling);
}
var cssTimeout = null;
function reloadCSS() {
    if (cssTimeout) return;
    cssTimeout = __hf.setTimeout(function() {
 ...
 */ function ImagesLoaded(elem, options, onAlways) {
        ...
        __hf.setTimeout(this.check.bind(this));
    }
...
var smoothscroll = createCommonjsModule(function(module, exports) {
     ...
     */ function step(context) {
                ...
                if (currentX !== context.x || currentY !== context.y) w.__hf.requestAnimationFrame(step.bind(w, context));
            }
            /**
    ...
    _createClass(_default, [
        ...
        },
        {
            ...
            value: function addSpeed() {
                if (window.pageYOffset != this.instance.scroll.y) this.instance.speed = (window.pageYOffset - this.instance.scroll.y) / Math.max(1, __hf.dateNow() - this.speedTs);
    ...
    (function() {
        ...
        root.Lethargy = (function() {
            ...
            Lethargy.prototype.check = function(e) {
                ...
                this.deltasTimestamp.push(__hf.dateNow());
            ...
            Lethargy.prototype.isInertia = function(direction) {
                ...
                if (this.deltasTimestamp[this.stability * 2 - 2] + this.delay > __hf.dateNow() && lastDeltas[0] === lastDeltas[this.stability * 2 - 1]) return false;
    ...
    _createClass(_default, [
        {
            ...
            value: function init() {
                ...
                this.vs.on(function(e) {
                    ...
                    if (!_this2.isDraggingScrollbar) __hf.requestAnimationFrame(function() {
        ...
        },
        {
            ...
            value: function startScrolling() {
                this.startScrollTs = __hf.dateNow(); // Record timestamp
        ...
        },
        {
            ...
            value: function stopScrolling() {
                __hf.cancelAnimationFrame(this.checkScrollRaf); // Prevent checkScroll to continue looping
                //Pevent scrollbar glitch/locking
                this.startScrollTs = undefined;
                if (this.scrollToRaf) {
                    __hf.cancelAnimationFrame(this.scrollToRaf);
        ...
        },
        {
            ...
            value: function checkKey(e) {
                ...
                if (this.stop) {
                    ...
                    if (e.keyCode == keyCodes$1.TAB) __hf.requestAnimationFrame(function() {
        ...
        },
        {
            ...
            value: function checkScroll() {
                ...
                if (forced || this.isScrolling || this.isDraggingScrollbar) {
                    if (!this.hasScrollTicking) {
                        this.checkScrollRaf = __hf.requestAnimationFrame(function() {
                    ...
                    var timeSinceStart = __hf.dateNow() - this.startScrollTs; // Get the time since the scroll was started: the scroll can be stopped again only past 100ms
        ...
        },
        {
            key: "addSpeed",
            value: function addSpeed() {
                if (this.instance.delta[this.directionAxis] != this.instance.scroll[this.directionAxis]) this.instance.speed = (this.instance.delta[this.directionAxis] - this.instance.scroll[this.directionAxis]) / Math.max(1, __hf.dateNow() - this.speedTs);
                else this.instance.speed = 0;
            }
        },
        {
        ...
        },
        {
            ...
            value: function moveScrollBar(e) {
                var _this5 = this;
                if (this.isDraggingScrollbar) __hf.requestAnimationFrame(function() {
        ...
        },
        {
            ...
            value: function scrollTo(target) {
                ...
                var start = __hf.dateNow();
                var loop1 = function loop() {
                    var p = (__hf.dateNow() - start) / duration; // Animation progress
                    if (p > 1) {
                        // Animation ends
                        render(1);
                        ...
                        _this9.scrollToRaf = __hf.requestAnimationFrame(loop);
                        render(easing(p));
                    }
                };
                loop1();
...
}, // alternative that's a bit faster and more reliably diverse but bigger:   for (let j, v, i = a.length; i; j = Math.floor(__hf.random() * i), v = a[--i], a[i] = a[j], a[j] = v); return a;
...
distribute = function distribute(v) {
    ...
    return _conditionalReturn(_isArray(min) ? !max : roundingIncrement === true ? (roundingIncrement = 0, false) : !returnFunction, function() {
        return _isArray(min) ? min[~~(__hf.random() * min.length)] : (roundingIncrement = roundingIncrement || 0.00001, returnFunction = roundingIncrement < 1 ? Math.pow(10, (roundingIncrement + "").length - 2) : 1) && Math.floor(Math.round((min - roundingIncrement / 2 + __hf.random() * (max - min + roundingIncrement * 0.99)) / roundingIncrement) * roundingIncrement * returnFunction) / returnFunction;
    });
}, pipe = function pipe() {
 ...
 */ _tickerActive, _ticker = function() {
    var _getTime = Date.now, _lagThreshold = 500, _adjustedLag = 33, _startTime = _getTime(), _lastUpdate = _startTime, _gap = 1000 / 240, _nextTime = _gap, _listeners = [], _id, _req, _raf, _self, _delta, _i, _tick1 = function _tick(v) {
        ...
        manual || (_id = _req(_tick)); //make sure the request is made before we dispatch the "tick" event so that timing is maintained. Otherwise, if processing the "tick" requires a bunch of time (like 15ms) and we're using a __hf.setTimeout() that's based on 16.7ms, it'd technically take 31.7ms between frames otherwise.
        ...
        wake: function wake() {
            if (_coreReady) {
                ...
                _req = _raf || function(f) {
                    return __hf.setTimeout(f, _nextTime - _self.time * 1000 + 1 | 0);
                };
                _tickerActive = 1;
                _tick1(2);
            }
