/* Original Codrops project: SlideshowAnimations. */
/* Generated deterministic HyperFrames adapter for codrops-slideshowanimations-index15. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const INTERACTION = {"mode":"transition","duration":6,"actions":[{"at":0.8,"type":"click","selector":".slides-nav__item--next"}]};
