/* Original Codrops project: ImageExpansionTypography. */
/* Generated deterministic HyperFrames adapter for codrops-imageexpansiontypography-index. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const INTERACTION = {"mode":"scroll","duration":8,"actions":[]};
  const AUDIT_ALLOWANCES = {"data-layout-allow-overlap":[".char",".word",".oh",".oh__inner","[data-splitting]",".anim"],"data-layout-allow-occlusion":[".oh__inner"]};
