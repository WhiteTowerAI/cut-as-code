/* Original Codrops project: LayersAnimation. */
/* Generated deterministic HyperFrames adapter for codrops-layersanimation-index3. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const INTERACTION = {"mode":"transition","duration":6,"actions":[{"at":0.8,"type":"click","selector":".layers"}]};
  const AUDIT_ALLOWANCES = {"data-layout-allow-overlap":[".char",".word",".oh",".oh__inner","[data-splitting]"],"data-layout-allow-occlusion":[".oh__inner",".content__inner"]};
  const SOURCE_BODY = "\n\t\t<main>\n\t\t\t<div class=\"frame\">\n\t\t\t\t<h1 class=\"frame__title\">Layers Animation with Clip-path</h1> \n\t\t\t\t<a class=\"frame__back\" href=\"https://tympanus.net/codrops/?p=74227\">Back to the article</a>\n\t\t\t\t<a class=\"frame__prev\" href=\"http://tympanus.net/Development/MotionTrailAnimations/\">Previous demo</a>\n\t\t\t\t<nav class=\"frame__demos\">\n\t\t\t\t\t<span>Variations: </span>\n\t\t\t\t\t<a href=\"index.html\" class=\"frame__demo\">1</a>\n\t\t\t\t\t<a href=\"index2.html\" class=\"frame__demo\">2</a>\n\t\t\t\t\t<a href=\"index3.html\" class=\"frame__demo frame__demo--current\">3</a>\n\t\t\t\t\t<a href=\"index4.html\" class=\"frame__demo\">4</a>\n\t\t\t\t\t<a href=\"index5.html\" class=\"frame__demo\">5</a>\n\t\t\t\t\t<a href=\"index6.html\" class=\"frame__demo\">6</a>\n\t\t\t\t</nav>\n\t\t\t</div>\n\t\t\t<div class=\"content\">\n\t\t\t\t<div class=\"content__inner\">\n\t\t\t\t\t<h2>Str#ngs</h2>\n\t\t\t\t\t<p>In the shadows, they dwell, with power to lease,<br>\n\t\t\t\t\t\tSociety’s strings, they pull in peace.<br>\n\t\t\t\t\t\tIn the grand show, they silently bark orders,<br>\n\t\t\t\t\t\tWhile we walk the path, within set borders.</p>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"content__inner hidden\">\n\t\t\t\t\t<h2>co$mos</h2>\n\t\t\t\t\t<p>They paint the sky gray, hide stars from our sight,<br>\n\t\t\t\t\t\tBut we've felt the cosmos, bathed in its light.<br>\n\t\t\t\t\t\tIn a digital desert, where mirages lead astray,<br>\n\t\t\t\t\t\tWe're seeking real oases, carving our own way.</p>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"layers\">\n\t\t\t\t\t<div class=\"layers__item\"><div class=\"layers__item-img\" style=\"background-image:url(img/10.jpg)\"></div></div>\n\t\t\t\t\t<div class=\"layers__item\"><div class=\"layers__item-img\" style=\"background-image:url(img/11.jpg)\"></div></div>\n\t\t\t\t\t<div class=\"layers__item\"><div class=\"layers__item-img\" style=\"background-image:url(img/9.jpg)\"></div></div>\n\t\t\t\t\t<div class=\"layers__item\"><div class=\"layers__item-img\" style=\"background-image:url(img/8.jpg)\"></div></div>\n\t\t\t\t\t<div class=\"layers__item\"><div class=\"layers__item-img\" style=\"background-image:url(img/6.jpg)\"></div></div>\n\t\t\t\t\t<div class=\"layers__item\"><div class=\"layers__item-img\" style=\"background-image:url(img/7.jpg)\"></div></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</main>\n\t\t\n\t\t\n\t\t\n\t\t\n\t";
