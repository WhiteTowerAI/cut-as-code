/* Original Codrops project: FullscreenClipEffect. */
/* Generated deterministic HyperFrames adapter for codrops-fullscreenclipeffect-index3. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const INTERACTION = {"mode":"transition","duration":6,"actions":[{"at":0.8,"type":"click","selector":"button.cover__button"}]};
  const AUDIT_ALLOWANCES = {"data-layout-allow-overlap":[".char",".word",".oh",".oh__inner","[data-splitting]"],"data-layout-allow-occlusion":[".oh__inner"],"data-layout-ignore":["main > div:nth-of-type(4) > h2 > span > span"]};
