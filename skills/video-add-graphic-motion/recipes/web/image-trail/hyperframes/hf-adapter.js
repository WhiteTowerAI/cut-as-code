/* Generated deterministic HyperFrames adapter for image-trail. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = false;
  const SOURCE_BODY = "<div class=\"trail\" style=\"width:340px;height:220px;border:1px solid #2a2b36;border-radius:14px;display:grid;place-items:center;color:#7c7f8c\">move inside this area</div>";
