/* Generated deterministic HyperFrames adapter for decrypted-text. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 style=\"font-family:ui-monospace,Menlo,monospace;font-size:34px;color:#39d98a\"><span class=\"decrypt\" data-text=\"ACCESS GRANTED\">ACCESS GRANTED</span></h1>";
