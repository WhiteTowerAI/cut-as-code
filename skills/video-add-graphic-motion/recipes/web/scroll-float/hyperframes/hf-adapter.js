/* Generated deterministic HyperFrames adapter for scroll-float. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 data-scroll-float style=\"font-size:36px;font-weight:800\">words that float into place</h1>";
