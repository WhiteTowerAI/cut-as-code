/* Generated deterministic HyperFrames adapter for glare-hover. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div class=\"glare\"><h3>motion, anything</h3><p>Move your cursor across the card — a soft glare follows.</p></div>";
