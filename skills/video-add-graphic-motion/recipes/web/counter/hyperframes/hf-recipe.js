...
(function(g){ 'use strict';
  ...
  function run(strips){ strips.forEach(function(o){ o.strip.style.transform= red()?('translateY(-'+o.target+'em)'):'translateY(0)'; });
    if(red()) return; __hf.requestAnimationFrame(function(){ __hf.requestAnimationFrame(function(){ strips.forEach(function(o){ o.strip.style.transform='translateY(-'+o.target+'em)'; }); }); }); }
