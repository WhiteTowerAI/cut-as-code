/* Generated deterministic HyperFrames adapter for click-spark. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = false;
  const SOURCE_BODY = "<button class=\"click-spark\" data-spark=\"#39d98a\" style=\"border:0;background:#8b7cf6;color:#fff;font:600 15px ui-sans-serif;padding:14px 24px;border-radius:12px;cursor:pointer\">✦ Click me</button>";
