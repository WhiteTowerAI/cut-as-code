/* Generated deterministic HyperFrames adapter for rotating-text. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 style=\"font-size:40px;font-weight:800\">motion, <span class=\"rot\" data-words=\"anything|faster|tasteful|on-brand\" style=\"color:#8b7cf6\">anything</span></h1>";
