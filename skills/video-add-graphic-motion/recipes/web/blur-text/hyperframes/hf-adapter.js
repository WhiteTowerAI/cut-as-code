/* Generated deterministic HyperFrames adapter for blur-text. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 data-blur-text style=\"font-size:40px;font-weight:800\">motion that means something</h1>";
