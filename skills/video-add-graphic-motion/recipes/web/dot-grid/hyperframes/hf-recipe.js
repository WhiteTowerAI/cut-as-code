...
(function(g){ 'use strict';
  ...
  function throttle(fn, limit){ var last=0; return function(){ var now=__hf.now();
  ...
  function start(el){
    ...
    el.addEventListener('pointermove', throttle(function(e){
      ...
      var now = __hf.now(), dt = mouse.lt ? now - mouse.lt : 16;
    ...
    function draw(t){
      ...
      if(!red) __hf.requestAnimationFrame(draw);
    }
    __hf.requestAnimationFrame(draw);
  }
