/* Generated deterministic HyperFrames adapter for gradual-blur. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div class=\"grad-blur\" style=\"width:280px;height:180px;overflow:auto;background:#14151c;border-radius:12px;padding:18px;text-align:left\"><p style=\"color:#b7b9c6;line-height:1.8\">Line one<br>Line two<br>Line three<br>Line four<br>Line five<br>Line six<br>Line seven<br>Line eight</p></div>";
