---
name: line-md-chevron-down-circle-twotone
description: Adapt the bundled Line MD Chevron Down Circle Twotone sticker from Line MD as a selective HyperFrames overlay.
---
