---
name: line-md-moon-alt-off-twotone
description: Adapt the bundled Line MD Moon Alt Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Moon Alt Off Twotone
