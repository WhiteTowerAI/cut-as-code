---
name: line-md-hazard-lights-off-loop
description: Adapt the bundled Line MD Hazard Lights Off Loop sticker from Line MD as a selective HyperFrames overlay.
---
