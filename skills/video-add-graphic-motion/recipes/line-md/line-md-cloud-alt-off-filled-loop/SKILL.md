---
name: line-md-cloud-alt-off-filled-loop
description: Adapt the bundled Line MD Cloud Alt Off Filled Loop sticker from Line MD as a selective HyperFrames overlay.
---
