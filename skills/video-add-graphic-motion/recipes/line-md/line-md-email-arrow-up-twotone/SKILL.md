---
name: line-md-email-arrow-up-twotone
description: Adapt the bundled Line MD Email Arrow Up Twotone sticker from Line MD as a selective HyperFrames overlay.
---
