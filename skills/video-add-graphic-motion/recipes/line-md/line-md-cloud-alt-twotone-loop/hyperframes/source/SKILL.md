---
name: line-md-cloud-alt-twotone-loop
description: Adapt the bundled Line MD Cloud Alt Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
