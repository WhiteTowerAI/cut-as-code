---
name: line-md-security-off-twotone
description: Adapt the bundled Line MD Security Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Security Off Twotone
