---
name: line-md-tablet-arrow-down-twotone
description: Adapt the bundled Line MD Tablet Arrow Down Twotone sticker from Line MD as a selective HyperFrames overlay.
---
