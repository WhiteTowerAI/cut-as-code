---
name: line-md-security-filled
description: Adapt the bundled Line MD Security Filled sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Security Filled
