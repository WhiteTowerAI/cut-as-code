---
name: line-md-email-arrow-down-filled
description: Adapt the bundled Line MD Email Arrow Down Filled sticker from Line MD as a selective HyperFrames overlay.
---
