---
name: line-md-cloud-alt-off-twotone-loop
description: Adapt the bundled Line MD Cloud Alt Off Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
