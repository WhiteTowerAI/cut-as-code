---
name: line-md-alert-circle-twotone-loop
description: Adapt the bundled Line MD Alert Circle Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
