---
name: line-md-play-to-pause-transition
description: Adapt the bundled Line MD Play To Pause Transition sticker from Line MD as a selective HyperFrames overlay.
---
