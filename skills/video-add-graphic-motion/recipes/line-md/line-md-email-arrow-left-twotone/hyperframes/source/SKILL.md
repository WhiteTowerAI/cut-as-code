---
name: line-md-email-arrow-left-twotone
description: Adapt the bundled Line MD Email Arrow Left Twotone sticker from Line MD as a selective HyperFrames overlay.
---
