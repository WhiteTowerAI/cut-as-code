---
name: line-md-alert-square-twotone-loop
description: Adapt the bundled Line MD Alert Square Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
