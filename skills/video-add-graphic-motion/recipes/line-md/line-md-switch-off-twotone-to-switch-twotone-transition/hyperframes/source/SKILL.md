---
name: line-md-switch-off-twotone-to-switch-twotone-transition
description: Adapt the bundled Line MD Switch Off Twotone To Switch Twotone Transition sticker from Line MD as a selective HyperFrames overlay.
---
