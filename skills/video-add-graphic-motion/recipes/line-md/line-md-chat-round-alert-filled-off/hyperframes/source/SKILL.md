---
name: line-md-chat-round-alert-filled-off
description: Adapt the bundled Line MD Chat Round Alert Filled Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Round Alert Filled Off
