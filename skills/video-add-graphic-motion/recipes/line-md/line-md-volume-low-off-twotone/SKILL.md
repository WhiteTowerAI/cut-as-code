---
name: line-md-volume-low-off-twotone
description: Adapt the bundled Line MD Volume Low Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Volume Low Off Twotone
