---
name: line-md-clipboard-remove-twotone
description: Adapt the bundled Line MD Clipboard Remove Twotone sticker from Line MD as a selective HyperFrames overlay.
---
