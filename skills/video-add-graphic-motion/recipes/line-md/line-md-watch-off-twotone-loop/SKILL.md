---
name: line-md-watch-off-twotone-loop
description: Adapt the bundled Line MD Watch Off Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
