---
name: line-md-folder-multiple-twotone
description: Adapt the bundled Line MD Folder Multiple Twotone sticker from Line MD as a selective HyperFrames overlay.
---
