---
name: line-md-map-marker-multiple-off-loop
description: Adapt the bundled Line MD Map Marker Multiple Off Loop sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Map Marker Multiple Off Loop
