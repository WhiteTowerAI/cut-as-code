---
name: line-md-briefcase-check-twotone
description: Adapt the bundled Line MD Briefcase Check Twotone sticker from Line MD as a selective HyperFrames overlay.
---
