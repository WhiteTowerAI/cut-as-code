---
name: line-md-arrow-right-square-twotone
description: Adapt the bundled Line MD Arrow Right Square Twotone sticker from Line MD as a selective HyperFrames overlay.
---
