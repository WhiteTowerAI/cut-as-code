---
name: line-md-monitor-arrow-down-filled
description: Adapt the bundled Line MD Monitor Arrow Down Filled sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Monitor Arrow Down Filled
