---
name: line-md-folder-arrow-left-filled
description: Adapt the bundled Line MD Folder Arrow Left Filled sticker from Line MD as a selective HyperFrames overlay.
---
