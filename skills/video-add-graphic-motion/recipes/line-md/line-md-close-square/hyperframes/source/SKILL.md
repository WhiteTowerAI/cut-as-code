---
name: line-md-close-square
description: Adapt the bundled Line MD Close Square sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Close Square
