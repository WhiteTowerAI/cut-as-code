---
name: line-md-chat-bubble-twotone-off
description: Adapt the bundled Line MD Chat Bubble Twotone Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Bubble Twotone Off
