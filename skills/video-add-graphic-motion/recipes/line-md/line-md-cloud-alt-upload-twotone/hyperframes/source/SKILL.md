---
name: line-md-cloud-alt-upload-twotone
description: Adapt the bundled Line MD Cloud Alt Upload Twotone sticker from Line MD as a selective HyperFrames overlay.
---
