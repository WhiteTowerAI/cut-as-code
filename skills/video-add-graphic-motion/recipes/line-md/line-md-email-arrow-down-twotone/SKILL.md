---
name: line-md-email-arrow-down-twotone
description: Adapt the bundled Line MD Email Arrow Down Twotone sticker from Line MD as a selective HyperFrames overlay.
---
