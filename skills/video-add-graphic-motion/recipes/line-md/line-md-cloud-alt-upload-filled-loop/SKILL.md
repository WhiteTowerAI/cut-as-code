---
name: line-md-cloud-alt-upload-filled-loop
description: Adapt the bundled Line MD Cloud Alt Upload Filled Loop sticker from Line MD as a selective HyperFrames overlay.
---
