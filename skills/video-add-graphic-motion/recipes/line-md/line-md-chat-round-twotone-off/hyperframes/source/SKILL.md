---
name: line-md-chat-round-twotone-off
description: Adapt the bundled Line MD Chat Round Twotone Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Round Twotone Off
