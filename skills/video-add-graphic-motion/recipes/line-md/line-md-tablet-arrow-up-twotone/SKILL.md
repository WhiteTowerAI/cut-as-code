---
name: line-md-tablet-arrow-up-twotone
description: Adapt the bundled Line MD Tablet Arrow Up Twotone sticker from Line MD as a selective HyperFrames overlay.
---
