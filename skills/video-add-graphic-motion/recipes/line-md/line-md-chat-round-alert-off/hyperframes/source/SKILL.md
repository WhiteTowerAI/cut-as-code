---
name: line-md-chat-round-alert-off
description: Adapt the bundled Line MD Chat Round Alert Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Round Alert Off
