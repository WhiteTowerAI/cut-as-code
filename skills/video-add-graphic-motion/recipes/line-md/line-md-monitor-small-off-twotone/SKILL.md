---
name: line-md-monitor-small-off-twotone
description: Adapt the bundled Line MD Monitor Small Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Monitor Small Off Twotone
