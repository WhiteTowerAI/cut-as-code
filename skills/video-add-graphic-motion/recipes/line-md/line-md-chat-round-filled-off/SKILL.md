---
name: line-md-chat-round-filled-off
description: Adapt the bundled Line MD Chat Round Filled Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Round Filled Off
