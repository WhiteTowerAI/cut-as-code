---
name: line-md-cloud-alt-print-filled
description: Adapt the bundled Line MD Cloud Alt Print Filled sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Cloud Alt Print Filled
