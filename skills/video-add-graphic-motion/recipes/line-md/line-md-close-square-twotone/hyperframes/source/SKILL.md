---
name: line-md-close-square-twotone
description: Adapt the bundled Line MD Close Square Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Close Square Twotone
