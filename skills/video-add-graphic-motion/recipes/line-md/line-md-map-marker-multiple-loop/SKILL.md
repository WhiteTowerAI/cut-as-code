---
name: line-md-map-marker-multiple-loop
description: Adapt the bundled Line MD Map Marker Multiple Loop sticker from Line MD as a selective HyperFrames overlay.
---
