---
name: line-md-cloud-off-twotone
description: Adapt the bundled Line MD Cloud Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Cloud Off Twotone
