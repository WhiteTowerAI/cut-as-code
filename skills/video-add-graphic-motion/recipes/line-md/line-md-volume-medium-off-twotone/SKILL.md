---
name: line-md-volume-medium-off-twotone
description: Adapt the bundled Line MD Volume Medium Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Volume Medium Off Twotone
