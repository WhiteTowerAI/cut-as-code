---
name: line-md-laptop-off-twotone
description: Adapt the bundled Line MD Laptop Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Laptop Off Twotone
