---
name: line-md-upload-off-twotone-loop
description: Adapt the bundled Line MD Upload Off Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
