---
name: line-md-chat-round-alert-twotone-off
description: Adapt the bundled Line MD Chat Round Alert Twotone Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Round Alert Twotone Off
