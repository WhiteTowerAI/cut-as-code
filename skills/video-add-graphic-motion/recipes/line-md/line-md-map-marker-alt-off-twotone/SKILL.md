---
name: line-md-map-marker-alt-off-twotone
description: Adapt the bundled Line MD Map Marker Alt Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---
