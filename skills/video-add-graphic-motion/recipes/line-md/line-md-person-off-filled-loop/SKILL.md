---
name: line-md-person-off-filled-loop
description: Adapt the bundled Line MD Person Off Filled Loop sticker from Line MD as a selective HyperFrames overlay.
---
