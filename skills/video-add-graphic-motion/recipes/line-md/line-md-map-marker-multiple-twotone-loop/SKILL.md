---
name: line-md-map-marker-multiple-twotone-loop
description: Adapt the bundled Line MD Map Marker Multiple Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Map Marker Multiple Twotone Loop
