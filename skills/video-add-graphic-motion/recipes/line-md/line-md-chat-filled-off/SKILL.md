---
name: line-md-chat-filled-off
description: Adapt the bundled Line MD Chat Filled Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Filled Off
