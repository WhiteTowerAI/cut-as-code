---
name: line-md-email-multiple-twotone
description: Adapt the bundled Line MD Email Multiple Twotone sticker from Line MD as a selective HyperFrames overlay.
---
