---
name: line-md-monitor-arrow-up-filled
description: Adapt the bundled Line MD Monitor Arrow Up Filled sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Monitor Arrow Up Filled
