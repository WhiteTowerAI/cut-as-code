---
name: line-md-cloud-alt-print-twotone
description: Adapt the bundled Line MD Cloud Alt Print Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Cloud Alt Print Twotone
