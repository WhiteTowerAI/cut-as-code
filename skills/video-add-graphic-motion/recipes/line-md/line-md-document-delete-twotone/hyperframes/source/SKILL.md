---
name: line-md-document-delete-twotone
description: Adapt the bundled Line MD Document Delete Twotone sticker from Line MD as a selective HyperFrames overlay.
---
