---
name: line-md-cloud-alt-upload-filled
description: Adapt the bundled Line MD Cloud Alt Upload Filled sticker from Line MD as a selective HyperFrames overlay.
---
