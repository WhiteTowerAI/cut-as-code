---
name: line-md-chat-twotone-off
description: Adapt the bundled Line MD Chat Twotone Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Chat Twotone Off
