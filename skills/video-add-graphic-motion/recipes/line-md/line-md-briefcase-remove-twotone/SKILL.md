---
name: line-md-briefcase-remove-twotone
description: Adapt the bundled Line MD Briefcase Remove Twotone sticker from Line MD as a selective HyperFrames overlay.
---
