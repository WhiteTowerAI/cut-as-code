---
name: line-md-pause-to-play-transition
description: Adapt the bundled Line MD Pause To Play Transition sticker from Line MD as a selective HyperFrames overlay.
---
