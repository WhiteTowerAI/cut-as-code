---
name: line-md-bell-alert-filled-loop
description: Adapt the bundled Line MD Bell Alert Filled Loop sticker from Line MD as a selective HyperFrames overlay.
---
