---
name: line-md-cookie-settings-twotone
description: Adapt the bundled Line MD Cookie Settings Twotone sticker from Line MD as a selective HyperFrames overlay.
---
