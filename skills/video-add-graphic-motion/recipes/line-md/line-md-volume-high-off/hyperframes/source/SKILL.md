---
name: line-md-volume-high-off
description: Adapt the bundled Line MD Volume High Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Volume High Off
