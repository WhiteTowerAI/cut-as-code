---
name: line-md-sunny-off-twotone
description: Adapt the bundled Line MD Sunny Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Sunny Off Twotone
