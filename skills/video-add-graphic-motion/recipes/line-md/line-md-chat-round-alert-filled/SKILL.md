---
name: line-md-chat-round-alert-filled
description: Adapt the bundled Line MD Chat Round Alert Filled sticker from Line MD as a selective HyperFrames overlay.
---
