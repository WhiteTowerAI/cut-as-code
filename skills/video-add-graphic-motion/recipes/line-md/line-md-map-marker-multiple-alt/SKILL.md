---
name: line-md-map-marker-multiple-alt
description: Adapt the bundled Line MD Map Marker Multiple Alt sticker from Line MD as a selective HyperFrames overlay.
---
