---
name: line-md-map-marker-alt-off-loop
description: Adapt the bundled Line MD Map Marker Alt Off Loop sticker from Line MD as a selective HyperFrames overlay.
---
