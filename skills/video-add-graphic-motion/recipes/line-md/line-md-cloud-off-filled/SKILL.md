---
name: line-md-cloud-off-filled
description: Adapt the bundled Line MD Cloud Off Filled sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Cloud Off Filled
