---
name: line-md-cloud-alt-upload-twotone-loop
description: Adapt the bundled Line MD Cloud Alt Upload Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
