---
name: line-md-map-marker-off-twotone
description: Adapt the bundled Line MD Map Marker Off Twotone sticker from Line MD as a selective HyperFrames overlay.
---
