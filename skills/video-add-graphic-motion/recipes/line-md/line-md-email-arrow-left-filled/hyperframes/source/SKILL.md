---
name: line-md-email-arrow-left-filled
description: Adapt the bundled Line MD Email Arrow Left Filled sticker from Line MD as a selective HyperFrames overlay.
---
