---
name: line-md-bell-alert-twotone-loop
description: Adapt the bundled Line MD Bell Alert Twotone Loop sticker from Line MD as a selective HyperFrames overlay.
---
