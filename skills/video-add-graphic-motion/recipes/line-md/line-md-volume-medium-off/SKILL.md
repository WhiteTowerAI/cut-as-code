---
name: line-md-volume-medium-off
description: Adapt the bundled Line MD Volume Medium Off sticker from Line MD as a selective HyperFrames overlay.
---

# Line MD Volume Medium Off
