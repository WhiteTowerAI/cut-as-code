...
},{}],"bnc3":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _utils.preloadImages)(), (0, _utils.preloadFonts)('mmi7prs')]).then(function () {
  ...
  lscroll.on('scroll', function (obj) {
    ...
    var transformVal = {
      translateY: (0, _utils.map)(distance, 150, -150, 30, -30),
      scale: (0, _utils.map)(Math.abs(distance), 0, 50, 1, 0.2)
...
},{"./utils":"MgTz","locomotive-scroll":"ez7q","splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"yIBK","splitting":"Qdhu"}]},{},["bnc3"], null)
}
];
