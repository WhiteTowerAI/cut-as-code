...
},{}],"VpRv":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _utils.preloadImages)(), (0, _utils.preloadFonts)('bxr7nka')]).then(function () {
  ...
  lscroll.on('scroll', function (obj) {
    ...
    var transformVal = {
      translateY: (0, _utils.map)(distance, 150, -150, 50, -50),
      rotate: (0, _utils.map)(distance, 150, -150, 10, -10)
    ...
    for (var _i = 0, _Object$keys = Object.keys(obj.currentElements); _i < _Object$keys.length; _i++) {
      ...
      if (obj.currentElements[key].el.classList.contains('content__img')) {
        ...
        var rotateX = progress < 0.5 ? (0, _utils.map)(progress, 0, 0.5, -20, 0) : (0, _utils.map)(progress, 0.5, 1, 0, 20);
        obj.currentElements[key].el.style.transform = "rotateX(".concat(rotateX, "deg)");
      }
    }
  });
});
},{"./utils":"MgTz","locomotive-scroll":"ez7q","splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"yIBK","splitting":"Qdhu"}]},{},["VpRv"], null)
}
];
