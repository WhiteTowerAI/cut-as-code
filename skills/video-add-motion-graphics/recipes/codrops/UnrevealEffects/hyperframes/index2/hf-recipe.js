...
(() => {
  ...
  s("1oYLf", function(e3, r3) {
    ...
    var s3, o2, a2, u2, h, l2, f, c2, p2, d2, _, m2, g2, v, y, x, T, w2, b, O, M, k, E, D, C, S, A = { autoSleep: 120, force3D: "auto", nullTargetWarn: 1, units: { lineHeight: "" } }, P = { duration: 0.5, overwrite: false, delay: 0 }, R = 2 * Math.PI, I = R / 4, z = 0, F = Math.sqrt, L = Math.cos, q = Math.sin, B = function(t10) {
      return "string" == typeof t10;
    }, U = function(t10) {
      return "function" == typeof t10;
    }, N = function(t10) {
      ...
      var i4;
      return w2 && !e10 && w2.selector ? w2.selector(t10) : B(t10) && !r4 && (M || !eS()) ? en.call((e10 || k).querySelectorAll(t10), 0) : G(t10) ? (void 0 === i4 && (i4 = []), t10.forEach(function(t11) {
        var e11;
      ...
      return B(i4) ? h2 = l3 = { center: 0.5, edges: 0.5, end: 1 }[i4] || 0 : !o3 && a3 && (h2 = i4[0], l3 = i4[1]), function(t11, o4, f2) {
        var c3, p3, d3, _2, m3, g3, v2, y2, x2, T2 = (f2 || e10).length, w3 = s4[T2];
        if (!w3) {
          if (!(x2 = "auto" === e10.grid ? 0 : (e10.grid || [1, 1e8])[1])) {
            for (v2 = -1e8; v2 < (v2 = f2[x2++].getBoundingClientRect().left) && x2 < T2; ) ;
            x2 < T2 && x2--;
          }
          for (w3 = s4[T2] = [], c3 = a3 ? Math.min(x2, T2) * h2 - 0.5 : i4 % x2, p3 = 1e8 === x2 ? 0 : a3 ? T2 * l3 / x2 - 0.5 : i4 / x2 | 0, v2 = 0, y2 = 1e8, g3 = 0; g3 < T2; g3++) d3 = g3 % x2 - c3, _2 = p3 - (g3 / x2 | 0), w3[g3] = m3 = u3 ? Math.abs("y" === u3 ? _2 : d3) : F(d3 * d3 + _2 * _2), m3 > v2 && (v2 = m3), m3 < y2 && (y2 = m3);
          "random" === i4 && eu(w3), w3.max = v2 - y2, w3.min = y2, w3.v = T2 = (parseFloat(e10.amount) || parseFloat(e10.each) * (x2 > T2 ? T2 - 1 : u3 ? "y" === u3 ? T2 / x2 : x2 : Math.max(x2, T2 / x2)) || 0) * ("edges" === i4 ? -1 : 1), w3.b = T2 < 0 ? n4 - T2 : n4, w3.u = ei(e10.amount || e10.each) || 0, r4 = r4 && T2 < 0 ? eL(r4) : r4;
        }
        return T2 = (w3[t11] - w3.min) / w3.max || 0, tE(w3.b + (r4 ? r4(T2) : T2) * w3.v) + w3.u;
      };
    }, el = function(t10) {
      var e10 = Math.pow(10, ((t10 + "").split(".")[1] || "").length);
      return function(r4) {
      ...
      var i4, n4, s4, o3 = t10.vars, a3 = o3[e10], u3 = w2, h2 = t10._ctx;
      if (a3) return i4 = o3[e10 + "Params"], n4 = o3.callbackScope || t10, r4 && t_.length && tS(), h2 && (w2 = h2), s4 = i4 ? a3.apply(n4, i4) : a3.call(n4), w2 = u3, s4;
    }, ev = function(t10) {
      return tW(t10), t10.scrollTrigger && t10.scrollTrigger.kill(!!T), 1 > t10.progress() && eg(t10, "onInterrupt"), t10;
    }, ey = [], ex = function(t10) {
      if (t10) if (t10 = !t10.name && t10.default || t10, X() || t10.headless) {
    ...
    var eW = function(t10, e10) {
      ...
      function t10(t11) {
        this.vars = t11, this._delay = +t11.delay || 0, (this._repeat = 1 / 0 === t11.repeat ? -2 : t11.repeat || 0) && (this._rDelay = t11.repeatDelay || 0, this._yoyo = !!t11.yoyo || !!t11.yoyoEase), this._ts = 1, t6(this, +t11.duration, 1, 1), this.data = t11.data, w2 && (this._ctx = w2, w2.data.push(this)), S || eC.wake();
      }
      var e10 = t10.prototype;
      return e10.delay = function(t11) {
        return t11 || 0 === t11 ? (this.parent && this.parent.smoothChildTiming && this.startTime(this._start + t11 - this._delay), this._delay = t11, this) : this._delay;
        ...
        if (this !== b && v2 > m3 && t11 >= 0 && (v2 = m3), v2 !== this._tTime || r5 || y2) {
          if (_2 !== this._time && g3 && (v2 += this._time - _2, t11 += this._time - _2), i4 = v2, f2 = this._start, u3 = !(l3 = this._ts), y2 && (g3 || (_2 = this._zTime), (t11 || !e11) && (this._zTime = t11)), this._repeat) {
            ...
            if (i4 = tE(v2 % a3), v2 === m3 ? (o3 = this._repeat, i4 = g3) : ((o3 = ~~(c3 = tE(v2 / a3))) && o3 === c3 && (i4 = g3, o3--), i4 > g3 && (i4 = g3)), c3 = tG(this._tTime, a3), !_2 && this._tTime && c3 !== o3 && this._tTime - c3 * a3 - this._dur <= 0 && (c3 = o3), p3 && 1 & o3 && (i4 = g3 - i4, d3 = 1), o3 !== c3 && !this._lock) {
              var x2 = p3 && 1 & c3, w3 = x2 === (p3 && 1 & o3);
              if (o3 < c3 && (x2 = !x2), _2 = x2 ? 0 : v2 % g3 ? g3 : v2, this._lock = 1, this.render(_2 || (d3 ? 0 : tE(o3 * a3)), e11, !g3)._lock = 0, this._tTime = v2, !e11 && this.parent && eg(this, "onRepeat"), this.vars.repeatRefresh && !d3 && (this.invalidate()._lock = 1, c3 = o3), _2 && _2 !== this._time || !this._ts !== u3 || this.vars.onRepeat && !this.parent && !this._act || (g3 = this._dur, m3 = this._tDur, w3 && (this._lock = 2, _2 = x2 ? g3 : -1e-4, this.render(_2, true), this.vars.repeatRefresh && !d3 && this.invalidate()), this._lock = 0, !this._ts && !u3)) return this;
            }
          }
    ...
    var eV, eQ, eG, eH, e$, eJ, eZ = function(t10, e10, r4, i4, n4, s4, o3) {
      ...
      var n4, s4, o3, a3, u3, h2, l3, f2, c3, p3, d3, _2, m3, g3 = e10.vars, v2 = g3.ease, y2 = g3.startAt, w3 = g3.immediateRender, O2 = g3.lazy, M2 = g3.onUpdate, k2 = g3.runBackwards, E2 = g3.yoyoEase, D2 = g3.keyframes, C2 = g3.autoRevert, S2 = e10._dur, A2 = e10._startAt, R2 = e10._targets, I2 = e10.parent, z2 = I2 && "nested" === I2.data ? I2.vars.targets : R2, F2 = "auto" === e10._overwrite && !x, L2 = e10.timeline, q2 = g3.easeReverse || E2;
      if (!L2 || D2 && v2 || (v2 = "none"), e10._ease = eq(v2, P.ease), e10._rEase = q2 && (eq(q2) || e10._ease), e10._from = !L2 && !!g3.runBackwards, e10._from && (e10.ratio = 1), !L2 || D2 && !g3.stagger) {
        if (_2 = (f2 = R2[0] ? tb(R2[0]).harness : 0) && g3[f2.prop], n4 = tq(g3, td), A2 && (A2._zTime < 0 && A2.progress(1), r4 < 0 && k2 && w3 && !C2 ? A2.render(-1, true) : A2.revert(k2 && S2 ? tc : tf), A2._lazy = 0), y2) {
          if (tW(e10._startAt = e7.set(R2, tz({ data: "isStart", overwrite: false, parent: I2, immediateRender: true, lazy: !A2 && Y(O2), startAt: null, delay: 0, onUpdate: M2 && function() {
            return eg(e10, "onUpdate");
          }, stagger: 0 }, y2))), e10._startAt._dp = 0, e10._startAt._sat = e10, r4 < 0 && (T || !w3 && !C2) && e10._startAt.revert(tc), w3 && S2 && r4 <= 0 && i4 <= 0) {
            r4 && (e10._zTime = r4);
            return;
          }
        } else if (k2 && S2 && !A2) if (r4 && (w3 = false), o3 = tz({ overwrite: false, data: "isFromStart", lazy: w3 && !A2 && Y(O2), immediateRender: w3, stagger: 0, parent: I2 }, n4), _2 && (o3[f2.prop] = _2), tW(e10._startAt = e7.set(R2, o3)), e10._startAt._dp = 0, e10._startAt._sat = e10, r4 < 0 && (T ? e10._startAt.revert(tc) : e10._startAt.render(-1, true)), e10._zTime = r4, w3) {
          if (!r4) return;
        } else t10(e10._startAt, 1e-8, 1e-8);
    ...
    var e7 = (function(t10) {
      function e10(e11, r5, n4, s4) {
        ...
        var o3, a3, u3, h2, l3, f2, c3, p3, d3 = t10.call(this, s4 ? r5 : tB(r5)) || this, _2 = d3.vars, m3 = _2.duration, g3 = _2.delay, v2 = _2.immediateRender, y2 = _2.stagger, T2 = _2.overwrite, w3 = _2.keyframes, O2 = _2.defaults, M2 = _2.scrollTrigger, k2 = r5.parent || b, E2 = (G(e11) || Q(e11) ? N(e11[0]) : "length" in r5) ? [e11] : eo(e11);
        if (d3._targets = E2.length ? tw(E2) : tu("GSAP target " + e11 + " not found. https://gsap.com", !A.nullTargetWarn) || [], d3._ptLookup = [], d3._overwrite = T2, w3 || y2 || V(m3) || V(g3)) {
          ...
          if ((o3 = d3.timeline = new eX({ data: "nested", defaults: O2 || {}, targets: k2 && "nested" === k2.data ? k2.vars.targets : E2 })).kill(), o3.parent = o3._dp = i3(d3), o3._start = 0, y2 || V(m3) || V(g3)) {
            ...
            tB(tz(o3.vars.defaults, { ease: "none" })), o3._ease = eq(w3.ease || r5.ease || "none");
            var C2, S2, P2, R2 = 0;
            if (G(w3)) w3.forEach(function(t11) {
              return o3.to(E2, t11, ">");
            }), o3.duration();
            else {
        ...
        return true !== T2 || x || (e$ = i3(d3), b.killTweensOf(E2), e$ = 0), tK(k2, i3(d3), n4), r5.reversed && d3.reverse(), r5.paused && d3.paused(true), (v2 || !m3 && !w3 && d3._start === tE(k2._time) && Y(v2) && (function t11(e12) {
          return !e12 || e12._ts && t11(e12.parent);
    ...
    var rd = [], r_ = {}, rm = [], rg = 0, rv = 0, ry = function(t10) {
      ...
      return e10.add = function(t11, e11, r4) {
        ...
        var i4 = this, n4 = function() {
          ...
          return n5 && n5 !== i4 && n5.data.push(i4), r4 && (i4.selector = ea(r4)), w2 = i4, t12 = e11.apply(i4, arguments), U(t12) && i4._r.push(t12), w2 = n5, i4.selector = s4, i4.isReverted = false, t12;
        };
      ...
      return e10.add = function(t11, e11, r4) {
        ...
        for (n4 in w2 && !o3.selector && (o3.selector = w2.selector), this.contexts.push(o3), e11 = o3.add("onMatch", e11), o3.queries = t11, t11) "all" === n4 ? s4 = 1 : (i4 = O.matchMedia(t11[n4])) && (0 > rd.indexOf(o3) && rd.push(o3), (a3[n4] = i4.matches) && (s4 = 1), i4.addListener ? i4.addListener(rx) : i4.addEventListener("change", rx));
    ...
    var i3, s3, o2, a2, u2, h, l2, f, c2, p2 = n("jxfTi"), d2 = {}, _ = 180 / Math.PI, m2 = Math.PI / 180, g2 = Math.atan2, v = /([A-Z])/g, y = /(left|right|width|margin|padding|x)/i, x = /[\s,\(]\S/, T = { autoAlpha: "opacity,visibility", scale: "scaleX,scaleY", alpha: "opacity" }, w2 = function(t3, e4) {
      ...
      if (T2 && ("height" === r4 || "width" === r4)) {
        var w3 = e4.style[r4];
        e4.style[r4] = 100 + n3, s4 = e4[v2], w3 ? e4.style[r4] = w3 : $(e4, r4);
      ...
      if (y2 && (l3 !== tg || h2 !== tg)) {
        var w3, b2 = parseFloat(h2) * m2, O2 = Math.sin(b2), M2 = Math.cos(b2);
        s4 = t_(v2, s4, -(O2 * (w3 = Math.cos(b2 = parseFloat(l3) * m2)) * y2)), o3 = t_(v2, o3, -(-Math.sin(b2) * y2)), a3 = t_(v2, a3, -(M2 * w3 * y2) + y2);
      }
      ...
      for (c3 in u2 || X(), this.styles = this.styles || U(t3), C2 = this.styles.props, this.tween = r4, e4) if ("autoRound" !== c3 && (o3 = e4[c3], !(p2._plugins[c3] && (0, p2._checkPlugin)(c3, e4, r4, i4, t3, n3)))) {
        if (l3 = typeof o3, f2 = to[c3], "function" === l3 && (l3 = typeof (o3 = o3.call(r4, i4, t3, n3))), "string" === l3 && ~o3.indexOf("random(") && (o3 = (0, p2._replaceRandom)(o3)), f2) f2(this, t3, c3, o3, r4) && (D2 = 1);
          ...
          if (R2 && c3 in R2 ? (s4 = "function" == typeof R2[c3] ? R2[c3].call(r4, i4, t3, n3) : R2[c3], (0, p2._isString)(s4) && ~s4.indexOf("random(") && (s4 = (0, p2._replaceRandom)(s4)), (0, p2.getUnit)(s4 + "") || "auto" === s4 || (s4 += p2._config.units[c3] || (0, p2.getUnit)(te(t3, c3)) || ""), "=" === (s4 + "").charAt(1) && (s4 = te(t3, c3))) : s4 = te(t3, c3), h2 = parseFloat(s4), (g3 = "string" === l3 && "=" === o3.charAt(1) && o3.substr(0, 2)) && (o3 = o3.substr(2)), a3 = parseFloat(o3), c3 in T && ("autoAlpha" === c3 && (1 === h2 && "hidden" === te(t3, "visibility") && a3 && (h2 = 0), C2.push("visibility", 0, P2.visibility), J(this, P2, "visibility", h2 ? "inherit" : "hidden", a3 ? "inherit" : "hidden", !a3)), "scale" !== c3 && "transform" !== c3 && ~(c3 = T[c3]).indexOf(",") && (c3 = c3.split(",")[0])), v2 = c3 in d2) {
            ...
            if (y2 || ((b2 = t3._gsap).renderTransform && !e4.parseTransform || tp(t3, e4.parseTransform), E2 = false !== e4.smoothOrigin && b2.smooth, (y2 = this._pt = new (0, p2.PropTween)(this._pt, P2, z, 0, 1, b2.renderTransform, b2, 0, -1)).dep = 1), "scale" === c3) this._pt = new (0, p2.PropTween)(this._pt, b2, "scaleY", b2.scaleY, (g3 ? (0, p2._parseRelative)(b2.scaleY, g3 + a3) : a3) - b2.scaleY || 0, w2), this._pt.u = 0, A2.push("scaleY", c3), c3 += "X";
  ...
  var c = document.querySelector(".content__overlay");
  var d = [];
  [...document.querySelectorAll(".preview__item")].forEach((e3) => {
    d.push(new (0, n2.PreviewItem)(e3));
  });
  var u = [];
  [...document.querySelectorAll(".content__item")].forEach((e3, t3) => {
    u.push(new (0, s2.ContentItem)(e3, d[t3]));
  });
  var w = -1;
  var m = false;
  var g = document.querySelector(".preview__back");
  for (let [e3, t3] of u.entries()) t3.DOM.imgWrap.addEventListener("click", () => {
    if (m) return;
    m = true, w = e3;
    let r3 = d[e3];
    i2.gsap.timeline({ defaults: { duration: 1, ease: "expo" }, onStart: () => {
      l.classList.add("preview-open"), i2.gsap.set(r3.DOM.el, { clipPath: `circle(0vmax at ${p.width / 2}px ${p.height / 2}px)` }), i2.gsap.set(r3.DOM.img, { scale: 0.8 }), i2.gsap.set(r3.DOM.title, { scale: 1.6 }), i2.gsap.set(r3.DOM.boxes, { xPercent: (e4) => e4 ? 20 : -20 }), i2.gsap.set(g, { x: "+=15%", opacity: 0 }), r3.DOM.el.classList.add("preview__item--current");
    }, onComplete: () => {
      i2.gsap.set(r3.DOM.el, { clipPath: "none" }), m = false;
    } }).addLabel("start", 0).addLabel("preview", "start+=0.3").to(t3.DOM.imgWrap, { ease: "power2", scale: 1.2 }, "start").to(c, { ease: "power2", scale: 1 }, "start").to(r3.DOM.el, { duration: 0.9, ease: "power2", clipPath: `circle(60vmax at ${p.width / 2}px ${p.height / 2}px)` }, "preview").to([r3.DOM.img, r3.DOM.title], { scale: 1 }, "preview").to(r3.DOM.boxes, { xPercent: 0 }, "preview").to(g, { ease: "power2", opacity: 1, x: "-=15%" }, "preview");
  }), t3.DOM.imgWrap.addEventListener("mouseenter", () => {
    i2.gsap.timeline({ defaults: { duration: 0.8, ease: "power4" } }).addLabel("start", 0).set(t3.DOM.titleInner, { transformOrigin: "0% 50%" }, "start").to(t3.DOM.titleInner, { startAt: { filter: "blur(0px)" }, duration: 0.2, ease: "power1.in", yPercent: -100, rotation: -4, filter: "blur(6px)" }, "start").to(t3.DOM.titleInner, { startAt: { yPercent: 100, rotation: 4, filter: "blur(6px)" }, yPercent: 0, rotation: 0, filter: "blur(0px)" }, "start+=0.2").to(t3.DOM.imgWrap, { scale: 0.95 }, "start").to(t3.DOM.img, { scale: 1.2 }, "start");
  ...
  g.addEventListener("click", () => {
    ...
    m = true;
    let e3 = d[w];
    i2.gsap.timeline({ defaults: { duration: 1, ease: "power2" }, onStart: () => {
      i2.gsap.set(e3.DOM.el, { clipPath: `circle(60vmax at ${p.width / 2}px ${p.height / 2}px)` });
    }, onComplete: () => {
      e3.DOM.el.classList.remove("preview__item--current"), l.classList.remove("preview-open"), m = false;
    } }).addLabel("start", 0).addLabel("content", "start+=0.2").to(g, { opacity: 0 }, "start").to(e3.DOM.title, { scale: 0.6 }, "start").to(e3.DOM.img, { scale: 0.9 }, "start").to(e3.DOM.el, { duration: 0.6, clipPath: `circle(0vmax at ${p.width / 2}px ${p.height / 2}px)` }, "start").to(c, { duration: 0.6, ease: "power3.inOut", scale: 0 }, "content").to(u[w].DOM.imgWrap, { startAt: { scale: 1.2 }, scale: 1 }, "content");
