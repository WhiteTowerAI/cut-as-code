/* Generated deterministic HyperFrames adapter for tab-bar-slide. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "\r\n  <div class=\"ui-tabs\"><div class=\"ind\"></div><button class=\"tb on\">⌂</button><button class=\"tb\">◎</button><button class=\"tb\">☰</button></div>\r\n  \r\n";
