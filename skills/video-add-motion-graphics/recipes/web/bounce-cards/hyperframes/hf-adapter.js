/* Generated deterministic HyperFrames adapter for bounce-cards. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div class=\"bcards\"><div class=\"bc\" style=\"background:linear-gradient(135deg,#8b7cf6,#6d54e6)\"></div><div class=\"bc\" style=\"background:linear-gradient(135deg,#39d98a,#2b9e73)\"></div><div class=\"bc\" style=\"background:linear-gradient(135deg,#ff8bd0,#d94f9a)\"></div></div>";
