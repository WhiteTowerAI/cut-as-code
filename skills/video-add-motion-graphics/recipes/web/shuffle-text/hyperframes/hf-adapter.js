/* Generated deterministic HyperFrames adapter for shuffle-text. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 style=\"font-size:40px;font-weight:800;letter-spacing:.05em\"><span class=\"shuffle\" data-text=\"LAUNCH DAY\">LAUNCH DAY</span></h1>";
