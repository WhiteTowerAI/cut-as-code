/* Generated deterministic HyperFrames adapter for gooey-nav. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<nav class=\"gnav\"><span class=\"gn-pill\"></span><button class=\"on\">Home</button><button>Work</button><button>About</button></nav>";
