/* Generated deterministic HyperFrames adapter for electric-border. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div class=\"electric\" style=\"padding:26px 34px;color:#e7e8ee\"><h3 style=\"margin:0\">⚡ Live now</h3></div>";
