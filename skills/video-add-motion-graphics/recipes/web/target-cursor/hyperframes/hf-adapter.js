/* Generated deterministic HyperFrames adapter for target-cursor. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = false;
  const SOURCE_BODY = "<button class=\"tc-target\" style=\"border:0;background:#8b7cf6;color:#fff;font:600 15px ui-sans-serif;padding:14px 24px;border-radius:12px;cursor:pointer\">Hover me</button>";
