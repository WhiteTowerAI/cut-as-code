...
(function(g){ 'use strict';
  ...
  function burst(el, x, y){ var n=8, host=document.createElement('div'); host.style.cssText='position:fixed;left:'+x+'px;top:'+y+'px;pointer-events:none;z-index:9999';
    for(var i=0;i<n;i++){ var s=document.createElement('span'); var a=(i/n)*Math.PI*2, d=18+__hf.random()*10;
    ...
    } document.body.appendChild(host); __hf.setTimeout(function(){ host.remove(); }, 520); }
