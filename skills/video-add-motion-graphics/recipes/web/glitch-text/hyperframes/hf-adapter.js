/* Generated deterministic HyperFrames adapter for glitch-text. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 class=\"glitch\" data-text=\"SYSTEM ONLINE\" style=\"font-size:44px\">SYSTEM ONLINE</h1>";
