...
(function(g){ 'use strict';
  ...
  function start(el){
    ...
    doResize();
    var resizeTimer; g.addEventListener('resize', function(){ __hf.clearTimeout(resizeTimer); resizeTimer = __hf.setTimeout(doResize, 100); });
    ...
    function tick(){
      ...
      if(!red) __hf.requestAnimationFrame(tick);
    }
    __hf.requestAnimationFrame(tick);
  }
