/* Generated deterministic HyperFrames adapter for pixel-card. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div class=\"pxc\" data-grid=\"8\" style=\"width:260px;height:160px;background:#14151c\"><div style=\"display:grid;place-items:center;height:100%;color:#e7e8ee;position:relative;z-index:1\">Hover me</div><div class=\"pxc-grid\"></div></div>";
