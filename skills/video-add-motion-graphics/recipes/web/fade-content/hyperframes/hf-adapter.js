/* Generated deterministic HyperFrames adapter for fade-content. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div style=\"display:grid;gap:14px\"><div class=\"fade-content\" style=\"background:#14151c;border:1px solid #2a2b36;border-radius:12px;padding:20px 26px\">Scroll me into view ↓</div><div class=\"fade-content\" style=\"--fc-delay:120ms;background:#14151c;border:1px solid #2a2b36;border-radius:12px;padding:20px 26px\">…staggered by delay</div></div>";
