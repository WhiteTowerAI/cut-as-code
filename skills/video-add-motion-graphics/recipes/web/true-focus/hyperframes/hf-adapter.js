/* Generated deterministic HyperFrames adapter for true-focus. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<h1 class=\"tf\" style=\"font-size:38px;font-weight:800\">design with real intent</h1>";
