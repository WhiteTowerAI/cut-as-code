/* Generated deterministic HyperFrames adapter for glass-icons. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div style=\"display:flex;gap:14px\"><button class=\"gi\">★</button><button class=\"gi\">♥</button><button class=\"gi\">✦</button><button class=\"gi\">➜</button></div>";
