/* Generated deterministic HyperFrames adapter for pixel-transition. */
(function () {
  "use strict";
  const FRAME_STEP = 0.016666666666666666;
  const TRACK_CSS = true;
  const SOURCE_BODY = "<div class=\"pixt\" data-grid=\"10\" style=\"width:260px;height:160px;background:#14151c\"><div style=\"display:grid;place-items:center;height:100%;color:#e7e8ee\">Hover me</div><div class=\"pixt-back\" style=\"--pixt-color:#39d98a\"></div></div>";
