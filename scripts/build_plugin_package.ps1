...
function Assert-PackageContents {
    ...
    $requiredFiles = @('.codex-plugin\plugin.json', '.mcp.json', 'LICENSE', 'PACKAGE_AUDIT.json', 'README.md', 'SBOM.spdx.json', 'THIRD_PARTY_NOTICES.md', 'runtime\hub-client.cjs', 'runtime\hub-trust.cjs', 'runtime\hub.cjs', 'runtime\mcp.cjs', 'runtime\project_snapshot.py', 'runtime\protocol_service.py', 'runtime\sidecar.cjs', 'ui\dist\index.html')
